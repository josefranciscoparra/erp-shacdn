...
export default function NewCalendarPage() {
  const permissionFallback = (
    <div className="@container/main flex flex-col gap-4 md:gap-6">
      <SectionHeader title="Nuevo calendario" />
      <EmptyState
  ...
  const { createCalendar, fetchCalendars } = useCalendarsStore();
      ...
      <div className="@container/main flex flex-col gap-4 md:gap-6">
        <div className="flex items-center gap-4">
          ...
          <div className="space-y-1">
            <h1 className="text-2xl font-semibold tracking-tight sm:text-3xl">Nuevo calendario</h1>
            <p className="text-muted-foreground text-sm">Crea un calendario de festivos o eventos corporativos</p>
          </div>
        </div>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="flex justify-end gap-2">
              <Button variant="outline" type="button" asChild>
                <Link href="/dashboard/calendars">Cancelar</Link>
              </Button>
