...
let MOCK_SHIFTS: Shift[] = [
  ...
  // Ferrán
  { id: 's1', employeeId: 'e1', date: '2025-11-18', startTime: '10:00', endTime: '20:00', costCenterId: 'cc1', zoneId: 'z1', role: 'Turno completo', status: 'published', createdAt: new Date(), updatedAt: new Date() },
  { id: 's2', employeeId: 'e2', date: '2025-11-18', startTime: '14:00', endTime: '20:00', costCenterId: 'cc1', zoneId: 'z2', role: 'Turno tarde', status: 'published', createdAt: new Date(), updatedAt: new Date() },
  // Vidrieria
  { id: 's3', employeeId: 'e3', date: '2025-11-18', startTime: '10:00', endTime: '20:00', costCenterId: 'cc2', zoneId: 'z4', role: 'Turno completo', status: 'published', createdAt: new Date(), updatedAt: new Date() },
  { id: 's4', employeeId: 'e4', date: '2025-11-18', startTime: '10:00', endTime: '14:00', costCenterId: 'cc2', zoneId: 'z5', role: 'Turno mañana', status: 'published', createdAt: new Date(), updatedAt: new Date() },
  // Rambla Catalunya
  { id: 's5', employeeId: 'e5', date: '2025-11-18', startTime: '10:00', endTime: '20:00', costCenterId: 'cc3', zoneId: 'z6', role: 'Turno completo', status: 'published', createdAt: new Date(), updatedAt: new Date() },
  { id: 's6', employeeId: 'e6', date: '2025-11-18', startTime: '10:00', endTime: '14:00', costCenterId: 'cc3', zoneId: 'z7', role: 'Turno mañana', status: 'published', createdAt: new Date(), updatedAt: new Date() },
  { id: 's7', employeeId: 'e7', date: '2025-11-18', startTime: '14:00', endTime: '20:00', costCenterId: 'cc3', zoneId: 'z8', role: 'Turno tarde', status: 'published', createdAt: new Date(), updatedAt: new Date() },
  // Diagonal 616
  { id: 's8', employeeId: 'e9', date: '2025-11-18', startTime: '10:00', endTime: '20:00', costCenterId: 'cc4', zoneId: 'z10', role: 'Turno completo', status: 'published', createdAt: new Date(), updatedAt: new Date() },
  { id: 's9', employeeId: 'e10', date: '2025-11-18', startTime: '14:00', endTime: '20:00', costCenterId: 'cc4', zoneId: 'z11', role: 'Turno tarde', status: 'published', createdAt: new Date(), updatedAt: new Date() },

  // MARTES 19
  // Ferrán
  { id: 's10', employeeId: 'e1', date: '2025-11-19', startTime: '10:00', endTime: '14:00', costCenterId: 'cc1', zoneId: 'z1', role: 'Turno mañana', status: 'published', createdAt: new Date(), updatedAt: new Date() },
  { id: 's11', employeeId: 'e2', date: '2025-11-19', startTime: '10:00', endTime: '20:00', costCenterId: 'cc1', zoneId: 'z2', role: 'Turno completo', status: 'published', createdAt: new Date(), updatedAt: new Date() },
  // Vidrieria
  { id: 's12', employeeId: 'e3', date: '2025-11-19', startTime: '14:00', endTime: '20:00', costCenterId: 'cc2', zoneId: 'z4', role: 'Turno tarde', status: 'published', createdAt: new Date(), updatedAt: new Date() },
  { id: 's13', employeeId: 'e4', date: '2025-11-19', startTime: '10:00', endTime: '20:00', costCenterId: 'cc2', zoneId: 'z5', role: 'Turno completo', status: 'published', createdAt: new Date(), updatedAt: new Date() },
  // Rambla Catalunya
  { id: 's14', employeeId: 'e5', date: '2025-11-19', startTime: '14:00', endTime: '20:00', costCenterId: 'cc3', zoneId: 'z6', role: 'Turno tarde', status: 'published', createdAt: new Date(), updatedAt: new Date() },
  { id: 's15', employeeId: 'e6', date: '2025-11-19', startTime: '10:00', endTime: '20:00', costCenterId: 'cc3', zoneId: 'z7', role: 'Turno completo', status: 'published', createdAt: new Date(), updatedAt: new Date() },
  { id: 's16', employeeId: 'e7', date: '2025-11-19', startTime: '10:00', endTime: '14:00', costCenterId: 'cc3', zoneId: 'z9', role: 'Turno mañana', status: 'published', createdAt: new Date(), updatedAt: new Date() },
  // Diagonal 545
  { id: 's17', employeeId: 'e11', date: '2025-11-19', startTime: '10:00', endTime: '20:00', costCenterId: 'cc5', zoneId: 'z12', role: 'Turno completo', status: 'published', createdAt: new Date(), updatedAt: new Date() },
  { id: 's18', employeeId: 'e12', date: '2025-11-19', startTime: '14:00', endTime: '20:00', costCenterId: 'cc5', zoneId: 'z13', role: 'Turno tarde', status: 'published', createdAt: new Date(), updatedAt: new Date() },

  // MIÉRCOLES 20 (algunos turnos en borrador)
  // Ferrán
  { id: 's19', employeeId: 'e1', date: '2025-11-20', startTime: '10:00', endTime: '20:00', costCenterId: 'cc1', zoneId: 'z1', role: 'Turno completo', status: 'draft', createdAt: new Date(), updatedAt: new Date() },
  { id: 's20', employeeId: 'e2', date: '2025-11-20', startTime: '14:00', endTime: '20:00', costCenterId: 'cc1', zoneId: 'z2', role: 'Turno tarde', status: 'draft', createdAt: new Date(), updatedAt: new Date() },
  // Rambla Catalunya (Pau de vacaciones)
  { id: 's21', employeeId: 'e5', date: '2025-11-20', startTime: '10:00', endTime: '20:00', costCenterId: 'cc3', zoneId: 'z6', role: 'Turno completo', status: 'draft', createdAt: new Date(), updatedAt: new Date() },
  { id: 's22', employeeId: 'e6', date: '2025-11-20', startTime: '10:00', endTime: '14:00', costCenterId: 'cc3', zoneId: 'z7', role: 'Turno mañana', status: 'draft', createdAt: new Date(), updatedAt: new Date() },
  { id: 's23', employeeId: 'e7', date: '2025-11-20', startTime: '14:00', endTime: '20:00', costCenterId: 'cc3', zoneId: 'z8', role: 'Turno tarde', status: 'draft', createdAt: new Date(), updatedAt: new Date() },
  // Diagonal 557
  { id: 's24', employeeId: 'e13', date: '2025-11-20', startTime: '10:00', endTime: '20:00', costCenterId: 'cc6', zoneId: 'z14', role: 'Turno completo', status: 'draft', createdAt: new Date(), updatedAt: new Date() },
  { id: 's25', employeeId: 'e14', date: '2025-11-20', startTime: '14:00', endTime: '20:00', costCenterId: 'cc6', zoneId: 'z15', role: 'Turno tarde', status: 'draft', createdAt: new Date(), updatedAt: new Date() },

  // JUEVES 21 (más turnos en borrador)
  // Vidrieria
  { id: 's26', employeeId: 'e3', date: '2025-11-21', startTime: '10:00', endTime: '20:00', costCenterId: 'cc2', zoneId: 'z4', role: 'Turno completo', status: 'draft', createdAt: new Date(), updatedAt: new Date() },
  { id: 's27', employeeId: 'e4', date: '2025-11-21', startTime: '10:00', endTime: '14:00', costCenterId: 'cc2', zoneId: 'z5', role: 'Turno mañana', status: 'draft', createdAt: new Date(), updatedAt: new Date() },
  // Diagonal 616
  { id: 's28', employeeId: 'e9', date: '2025-11-21', startTime: '14:00', endTime: '20:00', costCenterId: 'cc4', zoneId: 'z10', role: 'Turno tarde', status: 'draft', createdAt: new Date(), updatedAt: new Date() },
  { id: 's29', employeeId: 'e10', date: '2025-11-21', startTime: '10:00', endTime: '20:00', costCenterId: 'cc4', zoneId: 'z11', role: 'Turno completo', status: 'draft', createdAt: new Date(), updatedAt: new Date() },
  // Diagonal 545
  { id: 's30', employeeId: 'e11', date: '2025-11-21', startTime: '10:00', endTime: '14:00', costCenterId: 'cc5', zoneId: 'z12', role: 'Turno mañana', status: 'draft', createdAt: new Date(), updatedAt: new Date() },

  // VIERNES 22 (día con más afluencia, turnos más largos)
  // Ferrán
  { id: 's31', employeeId: 'e1', date: '2025-11-22', startTime: '10:00', endTime: '20:00', costCenterId: 'cc1', zoneId: 'z1', role: 'Turno completo', status: 'draft', createdAt: new Date(), updatedAt: new Date() },
  { id: 's32', employeeId: 'e2', date: '2025-11-22', startTime: '10:00', endTime: '20:00', costCenterId: 'cc1', zoneId: 'z2', role: 'Turno completo', status: 'draft', createdAt: new Date(), updatedAt: new Date() },
  // Rambla Catalunya
  { id: 's33', employeeId: 'e5', date: '2025-11-22', startTime: '10:00', endTime: '20:00', costCenterId: 'cc3', zoneId: 'z6', role: 'Turno completo', status: 'draft', createdAt: new Date(), updatedAt: new Date() },
  { id: 's34', employeeId: 'e6', date: '2025-11-22', startTime: '10:00', endTime: '20:00', costCenterId: 'cc3', zoneId: 'z7', role: 'Turno completo', status: 'draft', createdAt: new Date(), updatedAt: new Date() },
  { id: 's35', employeeId: 'e7', date: '2025-11-22', startTime: '14:00', endTime: '20:00', costCenterId: 'cc3', zoneId: 'z8', role: 'Turno tarde', status: 'draft', createdAt: new Date(), updatedAt: new Date() },
  // Diagonal 557
  { id: 's36', employeeId: 'e13', date: '2025-11-22', startTime: '10:00', endTime: '20:00', costCenterId: 'cc6', zoneId: 'z14', role: 'Turno completo', status: 'draft', createdAt: new Date(), updatedAt: new Date() },
]

/**
 * Plantillas de turnos rotativos
 */
let MOCK_TEMPLATES: ShiftTemplate[] = [
  {
    id: 't1',
...
export class ShiftServiceMock implements IShiftService {
  ...
  async hasMinimumRest(employeeId: string, date: string, startTime: string): Promise<boolean> {
    ...
    const restMinutes = currentStartMinutes >= prevEndMinutes ? currentStartMinutes - prevEndMinutes : 24 * 60 - prevEndMinutes + currentStartMinutes
