 ...
 */
export function validateShiftDuration(startTime: string, endTime: string, minHours = 0.5, maxHours = 16): string | null {
...
export function validateShiftConflicts(
  ...
  if (absence) {
    conflicts.push(createConflict('absence', `Empleado ausente: ${absence.reason} (${absence.start} - ${absence.end})`))
  }
