                ...
                <TableBody>
                  {displayedZones.map((zone) => (
                    <TableRow key={zone.id}>
                      ...
                      <TableCell>
                        <span className="text-muted-foreground text-sm">
                          {getCostCenterName(zone.costCenterId)}
                        </span>
                      </TableCell>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Estás a punto de eliminar la zona <strong>&quot;{zoneToDelete?.name}&quot;</strong>.
              Los turnos asignados a esta zona NO se eliminarán, pero ya no podrás crear nuevos turnos en ella.
