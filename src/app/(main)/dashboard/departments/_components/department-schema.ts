...
export const departmentFormSchema = z.object({
  ...
  costCenterId: z.string().optional().or(z.literal("")).or(z.literal("none")),
  managerId: z.string().optional().or(z.literal("")).or(z.literal("none")),
});
...
export const departmentUpdateSchema = departmentFormSchema.partial().transform((data) => ({
