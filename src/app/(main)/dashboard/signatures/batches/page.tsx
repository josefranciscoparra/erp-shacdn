...
import { ArrowLeft, ExternalLink, FileSignature, Loader2, RefreshCw } from "lucide-react";
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-muted-foreground flex items-center justify-between text-xs">
                    ...
                    {batch.rejectedCount > 0 && <span className="text-red-500">{batch.rejectedCount} rechazados</span>}
                  </div>
                </div>
