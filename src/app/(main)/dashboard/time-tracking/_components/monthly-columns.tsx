...
export const monthlyColumns: ColumnDef<MonthlySummary>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const average = row.getValue("averageWeekly") as number;
      ...
      const color = average >= expectedWeekly ? "text-green-600" : average >= expectedWeekly * 0.75 ? "text-yellow-600" : "text-red-600";
