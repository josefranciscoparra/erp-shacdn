...
import { ArrowLeft, Clock, ExternalLink, FileBarChart, Loader2, ShieldAlert, TrendingUp, Users } from "lucide-react";
...
export default function ProjectReportsPage() {
  const permissionFallback = (
    <div className="@container/main flex flex-col gap-4 md:gap-6">
      <SectionHeader title="Reportes de Proyecto" />
      <EmptyState
  ...
  if (isLoading) {
    return (
      <PermissionGuard permissions={["view_projects", "manage_projects"]} fallback={permissionFallback}>
