...
_Enfoque: "Gasta y luego te pago"_
...
_Enfoque: "Pide permiso, viaja con dietas y justifica"_
...
- [ ] **Niveles de Aprobación (Multi-step)**:
  ...
  - _Pendiente_: Implementar máquina de estados para pasar de `PENDING` -> `APPROVED_L1` -> `APPROVED_L2`.
