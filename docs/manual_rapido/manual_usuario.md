...
¡Hola! 👋  
Bienvenido a **TimeNow**, el portal del empleado donde podrás gestionar tu jornada laboral de forma sencilla.
...
Al iniciar sesión accederás a **Mi Espacio**, tu panel principal.

![IMG: dashboard-principal | Debe verse: saludo, botón fichar, estado del día | No debe verse: datos reales]
...
El fichaje registra tu tiempo de trabajo diario.

### Acceder a fichajes

- Desde el dashboard → **Fichar**
- O desde el menú → **Mi Espacio > Fichajes**

![IMG: fichajes-principal | Debe verse: botón fichar, contador | No debe verse: nombres reales]
...
Al finalizar verás un **resumen del día**.
...
> 💡 Algunas pausas pueden ser automáticas según la configuración de la empresa.
...
La solicitud será revisada por tu responsable.
...
- Dashboard → **Mis ausencias**
- Menú → **Mi Espacio > Ausencias**

![IMG: ausencias-principal | Debe verse: balance y botón nueva solicitud | No debe verse: datos reales]
...
El sistema calcula automáticamente los días hábiles.
...
![IMG: notificaciones | Debe verse: lista de notificaciones | No debe verse: datos reales]
...
Algunos campos solo pueden modificarlos RRHH.

---

## 11. Preguntas frecuentes

**¿Puedo usar TimeNow desde el móvil?**  
Sí, funciona en cualquier navegador moderno.

**¿Quién aprueba mis solicitudes?**  
Tu responsable o RRHH, según la configuración.

**¿A quién contacto si tengo problemas?**  
Contacta con RRHH o escribe a soporte@timenow.cloud
...
¿Necesitas más ayuda?  
Contacta con tu departamento de RRHH  
